            ...
            <div class="card-body">
                <form action="{{route('post.update')}}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <div class="form-group bmd-form-group">
                                <textarea type="text" rows="6" class="form-control" placeholder="body" name="body" value="{{ $post->body }}></textarea>
                                @error('body')
                                <span class="text-danger text-weight-bold">{{ $message }}</span>
                            @enderror
                            </div>
                        ...
                        <div class="col-md-12">
                            <div class="form-group bmd-form-group">
                                <textarea type="text" rows="6" class="form-control" placeholder="tags" name="tags" value="{{ $post->tags }}></textarea>
                                @error('tags')
                                <span class="text-danger text-weight-bold">{{ $message }}</span>
                            @enderror
                            </div>
