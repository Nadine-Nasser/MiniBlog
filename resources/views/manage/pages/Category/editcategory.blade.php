...
<head>
  ...
  <!-- Material Kit CSS -->
  <link href="{{ asset('manage/css/material-dashboard.css?v=2.1.0')}}" rel="stylesheet" />
</head>

<body class="dark-edition">
  <div class="wrapper ">
    @include('manage.include.sidebar')
    <div class="main-panel">
      <!-- Navbar -->
      @include('manage.include.navbar')
      <!-- End Navbar -->
      <div class="content">
  ...
  <script src="{{asset('mange/js/core/bootstrap-material-design.min.js')}}"></script>
  ...
  <script src="{{asset('mange/js/material-dashboard.js?v=2.1.0')}}"></script>
